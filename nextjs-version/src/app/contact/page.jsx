...
import { Button, Container, CssBaseline, Grid, Paper, styled, Typography } from "@mui/material";
        ...
        <Grid container spacing={2} sx={{flexWrap: {xs: "wrap", md: 'nowrap'}}}>
          ...
          <Grid item xs={12} md={6} sx={{mt: {md: "-60px"}}}>
            <ContactPaper>
              ...
              <Typography>Address: 4821 Hilt Croft Farm Road, Los Angeles, USA</Typography>
              <Button
                variant="contained"
                color="success"
                style={{ margin: '10px' }}
              ...
              <Typography variant="h6" style={{ marginTop: '20px' }}>Operating Hours</Typography>
